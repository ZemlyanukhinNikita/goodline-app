...
### 5. Создать метод проверки на валидность даты.(R1.9) -360 минут.
 ...
 #####  5.2 Методы исследования
    + Статья на habrahabr [java.time](https://habrahabr.ru/post/274905/ "java.time")
    + Чтение JavaDoc
...
|-------------------------------------|-------------------------------|--------------------------|
| 1.Создать консольное приложение     |  2 минуты                     | 3 минуты                 |
| 2.Аутентификация                    |  90 минут                     | 103 минуты               |
| 3.Авторизация                       |  132 минуты                   | 365 минут                |
| 4.Аккаунтинг                        |  20 минут                     | 330 минут                |
| 5.Метод проверки валидности даты    |  360 минут                    | 45 минут                 |
| 6.Метод проверки валидности объема  |  180 минут                    | 13 минут                 |
| 7.Commons CLI                       |  720 минут                    | 530 минут                |
| 8.Хеширование и соль                |  360 минут                    | 210 минут                |
| Итого                               |  1889 минут (31.5 часов)      | 1600 минут (26.5 часов)  |
